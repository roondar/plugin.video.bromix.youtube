...
from resources.lib._old_youtube import youtube_v3
import youtube_tv
...
class Provider(kodimon.AbstractProvider):
    def __init__(self, plugin=None):
        ...
        self._client = _old_youtube.Client(items_per_page=settings.get_items_per_page())
        pass
    ...
    def _on_channel(self, path, params, re_match):
        ...
        if page == 1:
            playlists_item = DirectoryItem(self.localize('_old_youtube.playlists'),
